 ...
 * <ul>
 * ResourceBundleMessageSourc建立在ResourceBundle接口志强
 ...
 * ReloadableResourceBundleMessageSource在不重启虚拟机情况下动态刷新
...
public interface MessageSource {
	...
	/**
	 * 尝试解析MessageSourceResolvable包含的消息。如果找不到消息，则产生异常
